...
![alpine](https://img.shields.io/badge/alpine-edge-0D597F?style=for-the-badge&logo=alpine-linux) ![lidarr](https://img.shields.io/badge/lidarr-${APP_VERSION}-blue?style=for-the-badge)
